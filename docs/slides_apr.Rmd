...
$$\pi _{t} = \alpha + \beta X_{t-k}$$

- Dinâmico

$$\pi _{t} = \alpha + \beta X_{t-k}+\delta Y_{t-1}$$

- Autoregressivo

$$\pi _{t} = \alpha + \beta X_{t-k}+ \gamma\pi_{t-1}$$

- Dinâmico Autoregressivo

$$\pi _{t} = \alpha + \beta X_{t-k}+\delta Y_{t-1}+\gamma\pi_{t-1}$$
...
author = {Riva, Enrico and Leite Netto, Cassio},
year = {2012},
month = {09},
pages = {},
title = {A INFLUÊNCIA DO CRÉDITO IMOBILIÁRIO E DO NÍVEL DE RENDA DAS PESSOAS NOS PREÇOS DOS IMÓVEIS RESIDENCIAIS NO MUNICÍPIO DE SÃO PAULO},
doi = {10.13140/2.1.1026.1764}
}$$
